...
For a normal user, download `com.redjohn.mobile-avatar-studio-0.1.5.tgz` from the [v0.1.5 release](https://github.com/JustYaz/redjohn-mobile-avatar-studio/releases/tag/v0.1.5) and add it through Unity Package Manager. For the latest development version, use this Git URL:
...
3. Select `com.redjohn.mobile-avatar-studio-0.1.5.tgz`.
...
- **Unity reports invalid package dependencies:** verify that the tarball contains a top-level `package/` directory and that the package is installed from the current `0.1.5` archive.
